            ...
            <div class="<?php echo esc_attr( $extra_attr['block_name'] ) ?>__content-wrapper">
				...
				if ( $showTitle || $showDate ):
                    ...
                    <header class="<?php echo esc_attr( $extra_attr['block_name'] ) ?>__entry-header">
						...
						<?php } ?>
						<?php
						if ( $showDate || $showCategories || $showCommentsCount ):
							?>
                                    ...
                                    <span class="<?php echo esc_attr( $extra_attr['block_name'] ); ?>__post-comments">
                                        <a href="<?php echo esc_url(get_comments_link()); ?>"><?php
	                                        if ( get_comments_number() ) {
		                                        echo sprintf( _n( '%d Comment', '%d Comments', get_comments_number(), 'booklium' ), get_comments_number() );
	                                        } else {
		                                        echo esc_html__( 'No comments', 'booklium' );
	                                        }
	                                        ?></a>
                                    </span>
								<?php } ?>
